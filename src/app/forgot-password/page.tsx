                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-100">
                    {status === 'success' ? (
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-medium text-slate-900">{t('auth.forgot_password.success_title')}</h3>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                >
                                    {status === 'loading' ? t('auth.loading') : t('auth.forgot_password.submit')}
                                </button>
                            </div>
                        </form>
                    )}
                    ...
                    <div className="mt-6">
                        <Link href="/login" className="flex items-center justify-center text-sm font-medium text-brand-600 hover:text-brand-500">
