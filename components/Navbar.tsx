      ...
      {isMenuOpen && (
        <div className="sm:hidden bg-white border-t border-gray-200">
          ...
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link to="/education" className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${isActive('/education') ? 'border-brand-500 text-brand-700 bg-brand-50' : 'border-transparent text-slate-600 hover:bg-slate-50 hover:border-brand-500 hover:text-brand-700'}`}>Centre d'Expertise</Link>
