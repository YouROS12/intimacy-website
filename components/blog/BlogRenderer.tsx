...
import { BlogContent, BlogBlock, BlogTheme } from '../../types';
                ...
                <div className="my-10 bg-gradient-to-br from-brand-50 to-white border border-brand-100 rounded-2xl p-8 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {products.map(product => (
                            <Link key={product.id} to={`/product/${product.id}`} className="flex flex-col sm:flex-row items-center gap-4 bg-white p-4 rounded-xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all border border-gray-100 group no-underline">
